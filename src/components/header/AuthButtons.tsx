...
export function AuthButtons() {
  return <div className="flex items-center space-x-4">
      <Link to="/login-cliente">
        <Button variant="outline" className="bg-transparent border-lavender-400 text-white hover:bg-lavender-500/20 mx-[25px]">
          Entrar
        </Button>
      </Link>
      <Popover>
        <PopoverTrigger asChild>
          <Button className="bg-lavender-400 hover:bg-lavender-500 text-teal-900 font-medium mx-[25px]">
            Criar Conta
          </Button>
        </PopoverTrigger>
